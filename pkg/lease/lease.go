...
func New(
	...
	le, err := leaderelection.NewLeaderElector(leaderelection.LeaderElectionConfig{
		...
		// The purpose of our lease is to determine time ranges for which a leader may
...
// kubeLeaseLock wraps the Kubernetes LeaseLock implementation and caches the time
